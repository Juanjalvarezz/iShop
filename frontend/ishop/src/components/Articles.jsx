...
import Article from "./Article"; // Importación del componente Article
...
const Articles = () => {
    ...
    const deleteArticle = (id) => {
        const idArticle = articles[id]._id; // Obtener el ID del artículo a eliminar
        axios.delete(url + "/delete/" + idArticle).then(res => {
            getArticles(); // Volver a obtener los artículos después de eliminar uno
        });
    }

    // Función para actualizar un artículo
    const updateArticle = (id, updatedData) => {
        const idArticle = articles[id]._id; // Obtener el ID del artículo a actualizar
        axios.put(url + "/put/" + idArticle, updatedData).then(res => {
            getArticles(); // Volver a obtener los artículos después de actualizar uno
        });
    };
    ...
    // Renderizar el componente Articles
    return (
